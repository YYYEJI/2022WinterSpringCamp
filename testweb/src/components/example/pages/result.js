...
function TestResult(props) {
    ...
    if(props.value === 4 || props.value === 5) {return <h3 className="test-result">많은 고민이 필요해요! <br></br>앞서 있었던 질문들을 다시 보며 고민을 해보세요.</h3>};
    if(props.value === 6 || props.value === 7) {return <h3 className="test-result">꽤 능력이 있네요! <br></br>노력하면 천재를 이길 수 있어요!</h3>};
    if(props.value === 8 || props.value === 9) {return <h3 className="test-result">뇌는 이미 컴공생이신군요! <br></br>컴공생이 되기 전에 미리 공부를 해보면 <br></br>좋을 것 같아요.</h3>};
    return null;
}
function Result() {
