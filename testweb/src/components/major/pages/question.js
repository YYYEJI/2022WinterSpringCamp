    ...
    return (
      ...
      <div className="question">
        <div className="question-block">
          ...
          <button className="button"><Link style={style} to="/major/result" state={{sum: sum}} >네. 그렇습니다.</Link></button><br/>
          <button className="button"><Link style={style} to="/major/result" state={{sum: sum}} >아니요. 그렇지 않습니다.</Link></button>
        </div>
      </div>
    );
